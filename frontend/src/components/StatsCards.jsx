...
export default function TaskItem({ task, section }) {
  ...
  // --- Mark as Completed (direct to "done") ---
  ...
  // --- Mark as In Progress (go from "done" -> "in_progress") ---
  ...
  return (
    <div
      className={`p-4 flex flex-col border rounded-lg shadow-sm transition ${
        task.status === "done"
    ...
    >
        ...
        <div className="flex flex-col flex-1">
          ...
          <div className="flex gap-2 mt-auto pt-3">
            <button
              ...
              className="flex-1 px-3 py-1.5 rounded-md bg-blue-600 text-white text-sm font-medium hover:bg-blue-700 transition"
            >
              {t("update")}
            </button>
            <button
              onClick={() => setIsEditing(false)}
              className="flex-1 px-3 py-1.5 rounded-md border border-gray-300 text-gray-700 text-sm font-medium hover:bg-gray-100 transition"
            >
              {t("cancel")}
            </button>
          </div>
          ...
          <div className="flex gap-2 mt-auto pt-3">
            {section === "pending" && (
              <>
                <button
                  ...
                  className="flex-1 px-3 py-1.5 rounded-md bg-green-600 text-white text-sm font-medium hover:bg-green-700 transition"
                >
                  {t("mark_completed")}
                </button>
                <button
                ...
                <button
                  ...
                  className="flex-1 px-3 py-1.5 rounded-md border border-red-500 text-red-600 text-sm font-medium hover:bg-red-50 transition"
                >
                  {t("delete")}
                </button>
              </>
            ...
            {section === "completed" && (
              <button
                ...
                className="flex-1 px-3 py-1.5 rounded-md border border-yellow-500 text-yellow-700 text-sm font-medium hover:bg-yellow-50 transition"
              >
                {t("mark_in_progress")}
              </button>
            )}
      ...
      {toast && (
        <div
          className={`fixed bottom-6 right-6 px-4 py-2 rounded-lg shadow-lg text-white text-sm transition ${
